...
print(prior_samples["mass_2_source"])
print(f'mass_2_source veri uzunluğu: {len(prior_samples["mass_2_source"])}')
...
# fig1 = prior_samples.plot("mass_2_source", type="hist", kde=True)
# plt.savefig("Prior_mass_2_source_hist.png", dpi=150, bbox_inches='tight')
# print("Plot kaydedildi: Prior_mass_2_source_hist.png")
