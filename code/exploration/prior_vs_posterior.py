...
axes[0].hist(posterior_samples["chirp_mass_source"], bins=50, density=True, alpha=0.7, label="Posterior")
axes[0].set_xlabel("chirp_mass_source")
axes[0].set_title("Posterior")
axes[1].hist(prior_samples["chirp_mass_source"], bins=50, density=True, alpha=0.7, color="orange", label="Prior")
axes[1].set_xlabel("chirp_mass_source")
